...
plugin_info_t Plugin_info = {
	...
	"RaubTieR", // plugin author
	"https://github.com/raub/parabot-raub", // plugin URL
	"PARABOT", // plugin logtag
...
extern "C" DLLEXPORT int Meta_Detach (PLUG_LOADTIME now, PL_UNLOAD_REASON reason) {
